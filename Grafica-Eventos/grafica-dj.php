...
<body>
    <main class="graf-general">
        <div class="contenedor-global-graf">
            <h4>DJ</h4>
            <p style="text-align: center;">Bienvenido a las estadísticas y datos de los DJ.<br>
                Estas gráficas muestra una comparación de duración (en horas) de cada DJ</p>
        ...
        <script>
            ...
            var myChart = new Chart(ctx, {
                type: "bar",
                data: {
                    labels: ['MPro Discoteca', 'likeDisco', 'Night', 'Infinity'],
                    datasets: [{
                        label: 'Horas',
                        data: [5, 5, 4, 6],
                        backgroundColor: [
