...
<main>
    <div class="contieneFormulario">
        <div class="formulario">
            <h1>Inicio de Sesion <br>
        <b style="color: rgb(114, 141, 187);">Proovedor</b> </h1>
            <form action="!!home_proveedor.php" method="POST">
                ...
                <input type="submit" value="Ingresar" name="envio_proveedor">
